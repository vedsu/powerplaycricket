    ...
    with col3:
        st.markdown(f"""
            <div style='text-align: center;'>
                <img src="{donor['Photo']}" style="border-radius: 50%; width:120px; height:120px; margin-top:10px; box-shadow: rgba(6, 24, 44, 0.4) 0px 0px 0px 2px, rgba(6, 24, 44, 0.65) 0px 4px 6px -1px, rgba(255, 255, 255, 0.08) 0px 1px 0px inset;">
            </div>
